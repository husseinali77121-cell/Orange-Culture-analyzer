...
body { font-family: 'Liberation Sans','Amiri','Noto Naskh Arabic','DejaVu Sans',Arial,sans-serif;
       font-size: 9.4pt; color: #16213a; direction: ltr; background: #fff;
       -weasy-hyphens: none; }
/* Arabic runs get the Naskh face explicitly */
.rtl, .ar { font-family:'Amiri','Noto Naskh Arabic','DejaVu Sans',sans-serif; }
...
.hdr-lab  { font-size:15pt; font-weight:bold; letter-spacing:0.15pt; }
...
.sec-ttl { font-size:9.6pt; font-weight:bold; color:#0d3b66; text-transform:uppercase;
