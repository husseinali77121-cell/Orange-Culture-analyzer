...
INTRINSIC_RESISTANCE = {
    ...
    # P. aeruginosa is intrinsically resistant to ALL of the following. Note that
    # among cephalosporins ONLY Ceftazidime, Cefepime and Cefoperazone/ceftolozane
    # etc. have anti-pseudomonal activity; every earlier-generation cephalosporin
    # (1st/2nd/most 3rd-gen) is intrinsically inactive and must be REPORTED AS
    # RESISTANT / not tested — never used to infer a β-lactamase mechanism.
    "pseudomonas aeruginosa": [
        # β-lactams — intrinsically inactive
        "Ampicillin", "Amoxicillin", "Amoxicillin + Clavulanic acid",
        "Ampicillin + Sulbactam",
        "Cephalexin", "Cefazolin", "Cefadroxil", "Cefaclor",
        "Cefuroxime", "Cefuroxime sodium", "Cefuroxime axetil", "Cefoxitin",
        "Cefotaxime", "Ceftriaxone", "Cefixime", "Cefpodoxime", "Ceftibuten",
        "Ertapenem",
        # Non-β-lactams — intrinsically inactive
...
ESBL_PRODUCERS = frozenset([
    ...
    "enterobacterales",   # generic unspeciated GNB option -- any Enterobacterales can carry ESBL
])
# NOTE: "enterobacterales" is intentionally left OUT of AMPC_PRODUCERS and
# INTRINSIC_RESISTANCE below: without a genus we must NOT assume chromosomal AmpC
# or genus-specific intrinsic resistance (e.g. Klebsiella's ampicillin). Conservative.
# AmpC-prone organisms (chromosomal inducible AmpC -- "SPICE/SPACE")
AMPC_PRODUCERS = frozenset([
    "enterobacter cloacae", "enterobacter spp.", "enterobacter aerogenes",
    "citrobacter freundii",   # only C. freundii is a strong chromosomal-AmpC producer (C. koseri is NOT)
    "serratia marcescens", "serratia spp.",
    "morganella morganii", "providencia spp.",
...
if uploaded:
    ...
    with col1:
        ...
        _under_1 = st.checkbox("👶 أقل من سنة (< 1 year)")
        if _under_1:
