...
def generate_decision_tree_image(
    ...
    refs = ["EUCAST Breakpoint Tables v16.1 (2026)","CLSI M100 Ed36","IDSA AMR Guidance 2026",
...
def generate_report(
    ...
    L += ["\nDISCLAIMER", sep,
          ...
          "Guidelines: EUCAST Breakpoint Tables v16.1 (2026) | CLSI M100 Ed36 | IDSA AMR Guidance 2026 | Egypt National",
